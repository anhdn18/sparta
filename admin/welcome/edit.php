...
$welcomeId = isset($_GET['id']) ? $_GET['id'] : -1;
$sql = "select * from welcomes where id = $welcomeId";
$welcome = queryExecute($sql, false);

if(!$welcome){
    header("location: " . ADMIN_URL . 'welcome?msg=welcome tồn tại');die;
}
 ?>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <main class="container">
        <form id="edit-slider-form" action="<?= ADMIN_URL . 'welcome/save-edit.php'?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" class="form-control"><?= $welcome['content']?></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-3">
                            <img src="<?= BASE_URL . $welcome['image'] ?>" id="preview-img" class="img-fluid">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-12 d-flex justify-content-end">
                    ...
                    <a href="<?= ADMIN_URL . 'welcome'?>" class="btn btn-danger">Hủy</a>
                </div>
            </div>
        </form>
...
<script>
    function encodeImageFileAsURL(element) {
        ...
        if(file === undefined){
            $('#preview-img').attr('src', "<?= BASE_URL . $welcome['image'] ?>");
            return false;
        }
